...
var getDataCountRoute = '/resource/tutorResourceCount';
var getDataRoute = '/resource/tutorResourceData';
var unit_id="";
    ...
    success: function (status) {
      ...
      for (var i = 0; i < status.length; i++) {
        ...
        var str = '<tr>' +
          ...
          '<td data-value="' + status[i].h_type + '">' + status[i].h_type + '</td>' +
          '<td data-value="' + status[i].resourceID + '"><p data-placement="top" data-toggle="tooltip" title="Edit">' +
          '<button class="btn btn-primary btn-xs uredit" style="margin-top:1px;" data-title="Edit" data-toggle="modal" name="' + status[i].resourceID + '" data-target="#edit">' +
      ...
      if (status.data.length > 0) {
        ...
        for (var i = 0; i < status.data.length; i++) {
          ...
          var str='<tr>' +
            ...
            '<button class="btn btn-primary btn-xs uredit" style="margin-top:1px;" data-title="Edit" data-toggle="modal" name="' + status.data[i].resourceID + '" data-target="#edit">' +
            '<span class="glyphicon glyphicon glyphicon-pencil">' +
            '</span>' +
            '</button>' +
            '</p>' +
