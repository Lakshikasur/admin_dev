...
module.exports.csrf = {
  ...
  origin: '*',
  routesDisabled: "/message/studentView,/message/studentInboxView,/message/stuMsgDelete," +
  "/message/stuMsgUpdate,/message/initHelpers," +
  "/message/showMsgReply,/message/stuMsgCreate,/message/getSentCount," +
  "/message/getInboxCount,/message/helperMessage," +
  "/gethelpermessage,/hlpmsg/addHelperMsg,/message/helperMsgView,/messages/hinit," +
  "/assessment/quiz_submit,/assessment/answer_submit," +
  "/assessment/answer_tf_submit,/assessment/answer_submit,/assessment/quiz_submit," +
  "/assessment/answer_yn_submit,/register,/assessment/answer_tf_submit,/message/ShowReplyData," +
  "/resource/addTutorChallengeResource, /message/stuInboxMsgUpdate, /message/studentTrashView,"+
  "/message/showSentMsg, /message/showMsgThread, /message/inboxReply, /message/tutorInboxView,"+
  "/message/showTutorMsgThread, /message/stuTutorMsgDelete, /message/stuInboxTutorMsgUpdate,"+
  "/message/tutorInboxReply, /message/studentInboxNotificationView, /message/deleteAttachment,"+
  "/message/foreverDelete,/resource/addTutorChallengeResource,/message/stuInboxMsgUpdate,/assessment/ws_answer_submit," +
  "/assessment/questionImageUpload,/assessment/answerImageUpload,/unit/addFaq,/unit/faqImageUpload,/unit/addGlossary," +
  "/message/paginateInbox, /message/paginateSend, /message/paginateTrash,/message/paginateTutorHelp,/initresourceunits," +
  "/tutorUnitResource,/unit/glossImageUpload "
